            ...
            <li class="nav-item">
              ...
              >
                ...
                <li class="nav-item">
                  <a
                    class="nav-link"
                    href="../dashboard/index-dual-horizontal.html"
                  >
                    <i class="icon">
                      <svg
                        class="icon-10"
                ...
                <li class="nav-item">
                  <a
                    class="nav-link"
                    href="../dashboard/index-boxed-fancy.html"
                  >
                    <i class="icon">
                      <svg
                        class="icon-10"
            ...
            <li class="nav-item">
              ...
              >
                ...
                <span class="item-name"
                  >Design System<span
                    class="badge rounded-pill bg-success item-name"
                    >UI</span
                  ></span
                >
              </a>
            ...
            <li class="nav-item">
              ...
              >
                ...
                <li class="nav-item">
                  <a
                    class="nav-link"
                    href="../dashboard/special-pages/rtl-support.html"
                  >
                    <i class="icon">
                      <svg
                        class="icon-10"
                      ...
                      <div class="p-0 card-body">
                        <a href="#" class="iq-sub-card">
                          <div class="d-flex align-items-center">
                            <img
                              class="p-1 avatar-40 rounded-pill bg-primary-subtle"
