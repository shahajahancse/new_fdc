{!! Form::open(['route' => 'producerBooking.st.status','class' => 'form-horizontal col-md-12']) !!}
    <!-- Section: Form -->
    <fieldset class="border p-3 mb-4">
        <legend class="float-none w-auto px-2">তথ্য হাল নাগাদ করুন</legend>
        <input type="hidden" name="booking" value="@php echo $booking->id; @endphp">
    ...
    <div class="form-group col-sm-12" style="text-align-last: right;">
        ...
        <a href="{{ route('producerBooking.forward.table') }}" class="btn btn-danger">{{ __('messages.cancel') }}</a>
    </div>
{!! Form::close() !!}
