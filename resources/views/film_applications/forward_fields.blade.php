{!! Form::open(['route' => 'filmApplications.st.status','class' => 'form-horizontal col-md-12']) !!}
    <!-- Section: Form -->
    ...
    <div class="form-group col-sm-12" style="text-align-last: right;">
        ...
        <a href="{{ route('filmApplications.forward.table') }}" class="btn btn-danger">{{ __('messages.cancel') }}</a>
    </div>
{!! Form::close() !!}
